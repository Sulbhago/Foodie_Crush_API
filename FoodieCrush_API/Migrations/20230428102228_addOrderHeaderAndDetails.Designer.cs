...
namespace FoodieCrush_API.Migrations
{
    ...
    [Migration("20230428102228_addOrderHeaderAndDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.CartItem", b =>
                {
                    b.HasOne("FoodieCrush_API.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodieCrush_API.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("FoodieCrush_API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("FoodieCrush_API.Models.OrderHeader", b =>
                {
                    b.HasOne("FoodieCrush_API.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodieCrush_API.Models.ApplicationUser", null)
                        .WithMany()
